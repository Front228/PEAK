...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!$title || !$brand || !$price || empty($sizes)) {
...
<main class="block__add">
    ...
    <form method="POST" enctype="multipart/form-data" class="form-add">
        ...
        <div class="form-columns-three">
            ...
            <div class="form-column form-column--text">
                ...
                <div class="form-group">
                    ...
                    <select name="category" required>
                        ...
                        <option value="флисовая одежда" <?= $product['category'] === 'флисовая одежда' ? 'selected' : '' ?>>Флисовая одежда</option>
                    </select>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="size-checkboxes">
                        <label><input type="checkbox" name="sizes[]" value="XS" <?= in_array('XS', $currentSizes) ? 'checked' : '' ?>> XS</label>
                        <label><input type="checkbox" name="sizes[]" value="S" <?= in_array('S', $currentSizes) ? 'checked' : '' ?>> S</label>
                        <label><input type="checkbox" name="sizes[]" value="M" <?= in_array('M', $currentSizes) ? 'checked' : '' ?>> M</label>
                        <label><input type="checkbox" name="sizes[]" value="L" <?= in_array('L', $currentSizes) ? 'checked' : '' ?>> L</label>
                        <label><input type="checkbox" name="sizes[]" value="XL" <?= in_array('XL', $currentSizes) ? 'checked' : '' ?>> XL</label>
                        <label><input type="checkbox" name="sizes[]" value="2XL" <?= in_array('2XL', $currentSizes) ? 'checked' : '' ?>> 2XL</label>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <select name="color" required>
                        ...
                        <option value="желтый" <?= $product['color'] === 'желтый' ? 'selected' : '' ?>>Желтый</option>
                        <option value="оранжевая" <?= $product['color'] === 'оранжевая' ? 'selected' : '' ?>>Оранжевая</option>
                        <option value="камуфляж" <?= $product['color'] === 'камуфляж' ? 'selected' : '' ?>>Камуфляж</option>
                        <option value="красный" <?= $product['color'] === 'красный' ? 'selected' : '' ?>>Красный</option>
                        <option value="зеленый" <?= $product['color'] === 'зеленый' ? 'selected' : '' ?>>Зеленый</option>
                        <option value="фиолетовый" <?= $product['color'] === 'фиолетовый' ? 'selected' : '' ?>>Фиолетовый</option>
                        <option value="коричневый" <?= $product['color'] === 'коричневый' ? 'selected' : '' ?>>Коричневый</option>
                    </select>
                </div>
            ...
            <!-- Центральная колонка: текущие изображения -->
            <div class="form-column form-column--current">
            ...
            <!-- Правая колонка: новые изображения -->
            <div class="form-column form-column--new">
                <div class="images-section">
                    ...
                    <div class="image-preview-container">
                        <div class="image-preview">
                            ...
                            <input type="file" name="image1" accept="image/*" onchange="previewImage(event, 'preview1')">
                        </div>
                    </div>
                    ...
                    <div class="image-preview-container">
                        <div class="image-preview">
                            ...
                            <input type="file" name="image2" accept="image/*" onchange="previewImage(event, 'preview2')">
                        </div>
                    </div>
                    ...
                    <div class="image-preview-container">
                        <div class="image-preview">
                            ...
                            <input type="file" name="image3" accept="image/*" onchange="previewImage(event, 'preview3')">
                        </div>
                    </div>
                    ...
                    <div class="image-preview-container">
                        <div class="image-preview">
                            ...
                            <input type="file" name="image4" accept="image/*" onchange="previewImage(event, 'preview4')">
                        </div>
                    </div>
                </div>
            </div>
...
.form-column--text input:focus,
.form-column--text select:focus {
    outline: none;
    border-color: #ff6b35;
}
