    ...
    <form method="POST" enctype="multipart/form-data" class="form-add">
        ...
        <div class="form-columns">
            ...
            <div class="form-column form-column--left">
                ...
                <!-- Блок размеров -->
                <div id="sizeBlock" class="form-group">
                    <label>Размеры *</label>
            ...
            <div class="form-column form-column--right">
                <div class="image-preview-container">
                    ...
                    <div class="image-preview">
                        ...
                        <input type="file" name="image1" accept="image/*" required onchange="previewImage(event, 'preview1')">
                    </div>
                </div>
        ...
        <br><a href="../index.php" class="back-link">← Назад к каталогу</a>
    </form>
</main>
<script>
// Превью изображений
...
// Скрытие блока размеров по умолчанию
