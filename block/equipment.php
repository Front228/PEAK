...
$productsFile = __DIR__ . '/../data/gear.json';
    ...
    <div class="filter-accordion">
        ...
        <div class="filter-accordion-content">
            <div class="filter-checkboxes">
                <label><input type="checkbox" value="лыжи"> Лыжи</label>
                <label><input type="checkbox" value="сноуборд"> Сноуборд</label>
                <label><input type="checkbox" value="шлема">шлема</label>
                <label><input type="checkbox" value="Спальные мешки">Спальные мешки</label>
                <label><input type="checkbox" value="рюкзак"> Рюкзаки</label>
                <label><input type="checkbox" value="Туристические коврики">Туристические коврики</label>
                <label><input type="checkbox" value="маски"> Визор</label>
            </div>
        </div>
    </div>
