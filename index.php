<?php session_start(); 
  $allProducts = [];
    foreach (['men', 'women', 'kids', 'gear', 'sales'] as $section) {
    $file = __DIR__ . "/data/{$section}.json";
    if (file_exists($file)) {
        $allProducts = array_merge($allProducts, json_decode(file_get_contents($file), true) ?: []);
    }
}
?>
<!doctype html>
<html lang="ru">
    ...
    <section class="main-section">
      <div class="swiper fullpage-swiper">
        ...
        <div class="block-title">
          <h1 class="title-text">Снаряжение, обувь и одежда</h1>
  ...
  <div class="brands-slider__wrapper">
    <!-- Контейнер трека -->
    <div class="brands-slider__track" id="brandsTrack">
      <!-- Оригинальные слайды -->
      <div class="brands-slider__slide">
        <a href="#" class="brand-link">
          <img src="public/icon/brends/arc-teryx.svg" alt="Arc'teryx" loading="lazy">
          
        </a>
      </div>
      <div class="brands-slider__slide">
        <a href="#" class="brand-link">
          <img src="public/icon/brends/adidas-18.svg" alt="adidas" loading="lazy">
          
        </a>
      </div>
      <div class="brands-slider__slide">
        <a href="#" class="brand-link">
          <img src="public/icon/brends/nike-4-2.svg" alt="Nike" loading="lazy">
          
        </a>
      </div>
      <div class="brands-slider__slide">
        <a href="#" class="brand-link">
          <img src="public/icon/brends/Columbia-logo.svg" alt="Columbia" loading="lazy">
          
        </a>
      </div>
      <div class="brands-slider__slide">
        <a href="#" class="brand-link">
          <img src="public/icon/brends/asics-6.svg" alt="Asics" loading="lazy">
          
        </a>
      </div>
      <div class="brands-slider__slide">
        <a href="#" class="brand-link">
          <img src="public/icon/brends/patagonia-1.svg" alt="Patagonia" loading="lazy">
          
        </a>
      </div>
      <div class="brands-slider__slide">
        <a href="#" class="brand-link">
          <img src="public/icon/brends/the-north-face-1.svg" alt="The North Face" loading="lazy">
          
        </a>
      </div>
      <div class="brands-slider__slide">
        <a href="#" class="brand-link">
          <img src="public/icon/brends/salomon.svg" alt="Salomon" loading="lazy">
          
        </a>
      </div>
      <div class="brands-slider__slide">
        <a href="#" class="brand-link">
          <img src="public/icon/brends/black-diamond.svg" alt="Black Diamond" loading="lazy">
          
        </a>
      </div>
      <div class="brands-slider__slide">
        <a href="#" class="brand-link">
          <img src="public/icon/brends/puma-2.svg" alt="PUMA" loading="lazy">
          
        </a>
      </div>
      <div class="brands-slider__slide">
        <a href="#" class="brand-link">
          <img src="public/icon/brends/mammut-1.svg" alt="Mammut" loading="lazy">
        </a>
      </div>

      <!-- Дублируем слайды для бесконечности -->
      <!-- Клонируем те же самые слайды -->
      <div class="brands-slider__slide">
        <a href="#" class="brand-link">
          <img src="public/icon/brends/arc-teryx.svg" alt="Arc'teryx" loading="lazy">
...
<section class="section_product-card" id="nextSection" >
  <h1 class="Title-brends padding-clamp">Новинки</h1>
  <div class="block-center-card" >
    <!-- 1 карточка -->
    <div class="product-card"
      data-images='["public/image/product/kurtka-mammut-eigerjoch-pro-in-hooded-jacket-tarn-065.webp",
                    "public/image/product/kurtka-mammut-eigerjoch-pro-in-hooded-jacket-tarn-165.webp",
                    "public/image/product/kurtka-mammut-eigerjoch-pro-in-hooded-jacket-tarn-265.webp",
                    "public/image/product/kurtka-mammut-eigerjoch-pro-in-hooded-jacket-tarn-365.webp"]'>
    <!-- Метка новинки -->
    <div class="product-badge">Новинка</div>
    
    <!-- Сердечко -->
    <button class="product-favorite" aria-label="Добавить в избранное">
    ...
    <div class="product-image-container">
      <img src="public/image/product/kurtka-arcteryx-gamma-hoody-mens-nightscape-065.webp" alt="Куртка Arcteryx GAMMA HOODY MENS, Nightscape" class="product-main-image">
      
      <!-- Второе изображение (появляется при наведении) -->
      <img src="public/image/product/kurtka-arcteryx-gamma-hoody-mens-nightscape-165.webp" alt="Вид сзади" class="product-hover-image">
    </div>
    ...
    <div class="product-info">
      ...
      <h3 class="product-title">Mammut Eigerjoch Pro IN Hooded Jacket, Tarn</h3>
      <div class="product-price">6 790 ₽</div>
  ...
  <!-- 2 карточка -->
    <div class="product-card"
          data-images='["public/image/product/kurtka-arcteryx-atom-hoody-m-forage-065.webp",
                        "public/image/product/kurtka-arcteryx-atom-hoody-m-forage-165.webp",
                        "public/image/product/kurtka-arcteryx-atom-hoody-m-forage-265.webp",
                        "public/image/product/kurtka-arcteryx-atom-hoody-m-forage-365.webp"
                        ]'>
      <!-- Метка новинки -->
      <div class="product-badge">Новинка</div>
      ...
      <!-- Основная картинка -->
      <div class="product-image-container">
        <img src="public/image/product/kurtka-arcteryx-beta-jacket-mens-lodestar-065.webp" alt="Куртка Arcteryx GAMMA HOODY MENS, Nightscape" class="product-main-image">
        
        <!-- Второе изображение (появляется при наведении) -->
        <img src="public/image/product/kurtka-arcteryx-beta-jacket-mens-lodestar-165.webp" alt="Вид сзади" class="product-hover-image">
      </div>
      ...
      <!-- Информация о товаре -->
      <div class="product-info">
        <div class="product-brand">Arcteryx</div>
        <h3 class="product-title">Arcteryx ATOM HOODY M, Forage</h3>
    ...
    <!-- 3 карточка -->
    <div class="product-card"
          data-images='["public/image/product/kurtka-arcteryx-thorium-hoody-nightscape-065.webp",
                        "public/image/product/kurtka-arcteryx-thorium-hoody-nightscape-165.webp",
                        "public/image/product/kurtka-arcteryx-thorium-hoody-nightscape-265.webp",
                        "public/image/product/kurtka-arcteryx-thorium-hoody-nightscape-365.webp"]'>
      <!-- Метка новинки -->
      <div class="product-badge">Новинка</div>
      ...
      <div class="product-info">
        <div class="product-brand">Arcteryx</div>
        <h3 class="product-title">Arcteryx THORIUM HOODY, Nightscape</h3>
    ...
    <!-- 4 карточка -->
    <div class="product-card"
          data-images='["public/image/product/kurtka-the-north-face-aconcagua-3-hoodie-black-065.webp",
                        "public/image/product/kurtka-the-north-face-aconcagua-3-hoodie-black-165.webp",
                        "public/image/product/kurtka-the-north-face-aconcagua-3-hoodie-black-265.webp"
                        ]'>
      <!-- Метка новинки -->
      <div class="product-badge">Новинка</div>
      ...
      <!-- Основная картинка -->
      <div class="product-image-container">
        <img src="public/image/product/kurtka-arcteryx-cerium-hoody-men-s-black-sapphire-065.webp" alt="Куртка Arcteryx GAMMA HOODY MENS, Nightscape" class="product-main-image">
        
        <!-- Второе изображение (появляется при наведении) -->
        <img src="public/image/product/kurtka-arcteryx-cerium-hoody-men-s-black-sapphire-165.webp" alt="Вид сзади" class="product-hover-image">
      </div>
      ...
      <div class="product-info">
        ...
        <h3 class="product-title">The North Face Aconcagua 3 Hoodie, Black</h3>
        <div class="product-price">5 290 ₽</div>
    ...
    <!-- 5 карточка -->
    <div class="product-card"
          data-images='["public/image/product/kurtka-arcteryx-beta-jacket-mens-trail-magic-065.webp",
                        "public/image/product/kurtka-arcteryx-beta-jacket-mens-trail-magic-165.webp",
                        "public/image/product/kurtka-arcteryx-beta-jacket-mens-trail-magic-265.webp",
                        "public/image/product/kurtka-arcteryx-beta-jacket-mens-trail-magic-365.webp"]'>
      <!-- Метка новинки -->
      <div class="product-badge">Новинка</div>
      ...
      <div class="product-info">
        <div class="product-brand">Arcteryx</div>
        <h3 class="product-title">Arcteryx BETA JACKET MENS, Trail Magic</h3>
    ...
    <!-- 6 карточка -->
    <div class="product-card"
          data-images='["public/image/product/kurtka-zhenskaya-bask-jump-lj-light-grey-065.webp",
                        "public/image/product/kurtka-zhenskaya-bask-jump-lj-light-grey-165.webp",
                        "public/image/product/kurtka-zhenskaya-bask-jump-lj-light-grey-265.webp",
                        "public/image/product/kurtka-zhenskaya-bask-jump-lj-light-grey-365.webp"]'>
      <!-- Метка новинки -->
      <div class="product-badge">Новинка</div>
      ...
      <!-- Информация о товаре -->
      <div class="product-info">
        <div class="product-brand">Bask</div>
        <h3 class="product-title">"BASK JUMP LJ, светло-серый</h3>
    ...
    <!-- 7 карточка -->
    <div class="product-card"
          data-images='["public/image/product/kurtka-zhenskaya-sivera-barmica-summit-az-cherry-065.webp",
                        "public/image/product/kurtka-zhenskaya-sivera-barmica-summit-az-cherry-165.webp",
                        "public/image/product/kurtka-zhenskaya-sivera-barmica-summit-az-cherry-265.webp",
                        "public/image/product/kurtka-zhenskaya-sivera-barmica-summit-az-cherry-365.webp"]'>
      <!-- Метка новинки -->
      <div class="product-badge">Новинка</div>
      ...
      <!-- Информация о товаре -->
      <div class="product-info">
        <div class="product-brand">Sivera</div>
        <h3 class="product-title">Sivera БАРМИЦА SUMMIT AZ, вишня</h3>
        <div class="product-price">26 600 ₽</div>
    ...
    <!-- 8 карточка -->
    <div class="product-card"
          data-images='["public/image/product/kostyum-alaskan-velona-yellow-grey-065.webp",
                        "public/image/product/kostyum-alaskan-velona-yellow-grey-165.webp",
                        "public/image/product/kostyum-alaskan-velona-yellow-grey-265.webp",
                        "public/image/product/kostyum-alaskan-velona-yellow-grey-365.webp"]'>
      <!-- Метка новинки -->
      <div class="product-badge">Новинка</div>
      ...
      <!-- Информация о товаре -->
      <div class="product-info">
        <div class="product-brand">Alaskan</div>
        <h3 class="product-title">Alaskan VELONA, жёлтый серый</h3>
        <div class="product-price">6 970 ₽</div>
...
<div class="video-container" id="videoContainer">
  <video autoplay muted loop playsinline id="mainVideo">
    <source src="public/video/457634_Ski_Skis_1920x1080.mp4" type="video/mp4">
  ...
  <!-- Кнопка паузы -->
  <button class="video-play-pause-btn" aria-label="Пауза">
    <img src="public/icon/pause-button.png" alt="Пауза" class="play-pause-icon">
  </button>
</div>
    ...
    <div class="logo-network">
      ...
      <nav class="footer_nav">
        <ul class="footer_list">
          ...
          <li class="footer_item"><a href="">Политика конфиденциальности</a></li>
          <li class="footer_item"><a href="">Согласие на получение рекламных рассылок</a></li>
          <li class="footer_item"><a href="">Поддержка</a></li>
          <li class="footer_item"><a href="">Согласие на обработку персональных данных</a></li>
          <li class="footer_item"><a href="">пользовательское соглашение</a></li>
        </ul>
      </nav>
      
    </div>
      <p class="Sp03ff">© 2025 ООО «Цифровые решения»</p>
</footer>
    <script src="src/js/badge.js"></script>
    <script src="src/js/app.js" type="module"></script>
    <script src="src/js/bugerMenu.js" loading="lazy"></script>
    <script src="src/js/swiper_card.js" type="module" loading="lazy"></script>
